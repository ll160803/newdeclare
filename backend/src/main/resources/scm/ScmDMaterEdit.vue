    ...
    export default {
        ...
        methods: {
            ...
            setFormValues ({...scmDMater}) {
                let fields = [  'id'     ,  'code'     ,  'name'     ,  'matnr'     ,  'mtart'     ,  'meins'     ,  'mseht'     ,  'txz01'     ,  'produceArea'     ,  'spec'     ,  'state'     ,  'bklas'     ,  'spellCode'     ,  'gysaccount'     ,  'isDeletemark'     ,  'createTime'     ,  'modifyTime'     ,  'createUserId'     ,  'modifyUserId'   ]
