...
public class DcaBLetter implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="通讯评审时间", writeConverter = DateConverter.class)
    private Date letterDate;
    private transient String letterDateFrom;
    private transient String letterDateTo;

    /**
     * 通讯评审结果
     */
        
        @ExcelField(value ="通讯评审结果")
    private String letterJl;

    /**
     * 有效期
     */
        
        @ExcelField(value ="有效期", writeConverter = DateConverter.class)
    ...
    public static final String LETTER_DATE ="letter_date" ;

    public static final String LETTER_JL ="letter_jl" ;
