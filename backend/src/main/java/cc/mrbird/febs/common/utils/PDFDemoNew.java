...
//    private Color blue = new Color(0, 0, 255); // 蓝色
    ...
    public void writePdf2021_1(CustomApplyFirst customApplyFirst, String fileName, String outWatermarkFileName, ArrayList<String> mergeAddPdfList, String watermarkName) throws Exception {
        ...
        String titleExp_11 = "10." + strKongGe + "“论文影响力”可以填写发表的论文截止当年10月31日被收录情况（提供相应的被收";
        expTitleList.add(titleExp_11);
        String titleExp_11_1 = strKongGe_1 + "录报告）、引用情况（提供相应的他引次数报告）等。";
        expTitleList.add(titleExp_11_1);
        String titleExp_12 = "11." + strKongGe + "如有一个以上的“第一作者或通讯作者”，请注明“2个同等贡献作者之一”或“3个并";
        expTitleList.add(titleExp_12);
        String titleExp_12_1 = strKongGe_1 + "列通讯作者之一”等。";
        expTitleList.add(titleExp_12_1);
        String titleExp_13 = "12." + strKongGe + "“代表作同行评议结果”的“推荐意见”填写“积极推荐”、“一般推荐”或“不推荐”；";
        expTitleList.add(titleExp_13);
        String titleExp_13_1 = strKongGe_1 + "“评审结果”填写“通过”或“未通过”。";
...
//        expTitleList.add(titleExp_14_1);
        String titleExp_15 = "13." + strKongGe + "“已毕业硕士、博士论文获奖情况”填写学位论文获国家级、省级优秀论文情况。";
        expTitleList.add(titleExp_15);
        String titleExp_16 = "14." + strKongGe + "“专利类别”填写“发明专利”、“实用新型专利”、“外观设计专利”等。";
        expTitleList.add(titleExp_16);
        String titleExp_17 = "15." + strKongGe + "“其他工作及成果”填写表中未涉及的其他工作情况。";
        expTitleList.add(titleExp_17);
        String titleExp_18 = "16." + strKongGe + "“拟聘岗位工作思路及预期目标”填写申请岗位聘任后的工作计划、思路及工作目标等，";
...
//        table.addCell(cell);
        ...
        for (TableValue item : tableValueList4_1) {
            ...
            table.addCell(cell);
            //6 收录情况
            cell = new PdfPCell(new Phrase(handleEmptyString(item.getField6())+"/"+handleEmptyString(item.getField7())+"/"+handleEmptyString(item.getField8()), font));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            //    cell.setFixedHeight(contentHeight35);
            cell.setColspan(4);
...
//            table.addCell(cell);
            //9 第一或通讯作者
            cell = new PdfPCell(new Phrase(zuozhe(item.getField9()), font));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            //    cell.setFixedHeight(contentHeight35);
            cell.setColspan(2);
...
//        table.addCell(cell);
        ...
        table.addCell(cell);
        //他引次数
        cell = new PdfPCell(new Phrase("论文/\n专著影\n响力", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight40);
        cell.setColspan(2);
...
//            table.addCell(cell);
            ...
            table.addCell(cell);
            //8 他引次数
            cell = new PdfPCell(new Phrase(handleEmptyString(item.getField6())+"/"+ handleEmptyString(item.getField8()), font));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            //        cell.setFixedHeight(contentHeight35);
            cell.setPaddingTop(top);
        ...
        //列六
        //
        cell = new PdfPCell(new Phrase("代表作同行评议结果", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight40);
        cell.setColspan(numColumns);
        ...
        cell = new PdfPCell(new Phrase("推荐意见1", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight35);
        cell.setColspan(3);
        ...
        cell = new PdfPCell(new Phrase("推荐意见2", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight35);
        cell.setColspan(3);
        ...
        cell = new PdfPCell(new Phrase("推荐意见3", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight35);
        cell.setColspan(3);
        ...
        cell = new PdfPCell(new Phrase("推荐意见4", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight35);
        cell.setColspan(4);
        ...
        cell = new PdfPCell(new Phrase("推荐意见5", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight35);
        cell.setColspan(4);
        ...
        cell = new PdfPCell(new Phrase("推荐意见6", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight35);
        cell.setColspan(4);
        ...
        cell = new PdfPCell(new Phrase("评审结果", font));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell.setFixedHeight(contentHeight35);
        cell.setColspan(4);
...
//        }).collect(Collectors.toList());
     ...
     * @throws Exception
     */
    public void writePdf2021(CustomApplyFirst customApplyFirst, String fileName, String outWatermarkFileName, ArrayList<String> mergeAddPdfList, String watermarkName) throws Exception {
        Document document = new Document(PageSize.A4, 50, 50, 50, 50);
        FileOutputStream out = new FileOutputStream(fileName);
        PdfWriter writer = PdfWriter.getInstance(document, out);
        ...
        String title1_9_1 = "主 要 学 习 及 工 作 经 历 （从本科开始填写，含国内外进修情况按时间正序连续填写）";
        String title1_10_1 = "自何年月";
        String title1_10_2 = "至何年月";
        String title1_10_3 = "在何地、何学校、何单位任职 （或学习）";
        String title1_10_4 = "证明人";
...
//            }
            ...
            //第几作者
            listCells.add(generatePdfValue(pdfStyle_t, zuozhe(zz), 3, 0));
            ++kindex;
        }
        List<DcaBCopyPublicarticle> publicarticleList = customApplyFirst.getDcaBPublicarticleList();
        publicarticleList = publicarticleList.stream().sorted(new Comparator<DcaBCopyPublicarticle>() {
