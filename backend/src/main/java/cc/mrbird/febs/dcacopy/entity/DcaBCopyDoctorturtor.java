...
@Excel("dca_b_copy_doctorturtor")
@Data
@Accessors(chain = true)
public class DcaBCopyDoctorturtor implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     * 导师类型
     */
            @ExcelField(value ="导师类型")
    private String turtorType;

    /**
     * 任职时间
     */
            @ExcelField(value ="任职时间")
    private Date turtorDate;
    private transient String turtorDateFrom;
    private transient String turtorDateTo;
    ...
    public static final String TURTOR_TYPE ="turtor_type" ;

    public static final String TURTOR_DATE ="turtor_date" ;
