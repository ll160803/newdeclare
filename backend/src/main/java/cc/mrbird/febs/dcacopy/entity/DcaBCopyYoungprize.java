...
@Excel("dca_b_copy_youngprize")
@Data
@Accessors(chain = true)
public class DcaBCopyYoungprize implements Serializable{
...
private static final long serialVersionUID=1L;
    ...
    private transient String prizeDateFrom;
    private transient String prizeDateTo;
    ...
    public static final String PRIZE_JB ="prize_jb" ;

    public static final String PRIZE_GRADE ="prize_grade" ;

    public static final String RANKNUM ="ranknum" ;

    public static final String PRIZE_DATE ="prize_date" ;
