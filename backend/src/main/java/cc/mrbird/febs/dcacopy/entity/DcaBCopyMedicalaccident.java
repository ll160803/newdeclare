...
@Excel("dca_b_copy_medicalaccident")
@Data
@Accessors(chain = true)
public class DcaBCopyMedicalaccident implements Serializable{
...
private static final long serialVersionUID=1L;
    ...
    public static final String MEDICAL_YEAR ="medical_year" ;

    public static final String MEDICAL_RESULT ="medical_result" ;
