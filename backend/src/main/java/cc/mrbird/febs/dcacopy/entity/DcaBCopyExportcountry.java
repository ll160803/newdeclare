...
@Excel("dca_b_copy_exportcountry")
@Data
@Accessors(chain = true)
public class DcaBCopyExportcountry implements Serializable{
...
private static final long serialVersionUID=1L;
    ...
    public static final String CGSJ ="cgsj" ;

    public static final String HGSJ ="hgsj" ;
