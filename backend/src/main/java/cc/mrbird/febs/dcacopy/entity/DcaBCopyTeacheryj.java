...
@Excel("dca_b_copy_teacheryj")
@Data
@Accessors(chain = true)
public class DcaBCopyTeacheryj implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     * 任职（获得）时间
     */
            @ExcelField(value ="任职（获得）时间")
    private Date teachDate;
    private transient String teachDateFrom;
    private transient String teachDateTo;
    ...
    public static final String TEACH_DATE ="teach_date" ;

    public static final String TEACH_CONTENT ="teach_content" ;
