...
@Excel("dca_b_copy_talent")
@Data
@Accessors(chain = true)
public class DcaBCopyTalent implements Serializable{
...
private static final long serialVersionUID=1L;
    ...
    public static final String TALET_NAME ="talet_name" ;

    public static final String TALENT_START_DATE ="talent_start_date" ;

    public static final String TALENT_END_DATE ="talent_end_date" ;
