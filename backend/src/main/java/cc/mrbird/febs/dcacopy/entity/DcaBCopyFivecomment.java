...
@Excel("dca_b_copy_fivecomment")
@Data
@Accessors(chain = true)
public class DcaBCopyFivecomment implements Serializable{
...
private static final long serialVersionUID=1L;
    ...
    public static final String FIVE_PERCENT ="five_percent" ;
