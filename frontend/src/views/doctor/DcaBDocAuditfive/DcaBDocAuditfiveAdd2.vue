...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setFields () {
                let values = this.form.getFieldsValue([                    'khjg'    ,                     'year'    ,                     'userAccountName'    ,                     'userAccount'    ,                     'zzbx'    ,                     'zydd'    ,                     'ljzl'    ,                     'ywnlgztd'    ,                     'grkyjz'    ,                     'xndkykt'    ,                     'adContent'                   ])
                if (typeof values !== 'undefined') {
                    Object.keys(values).forEach(_key => { this.dcaBDocAuditfive[_key] = values[_key] })
                }
            }
        }
    }
