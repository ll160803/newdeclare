      ...
      <a-card title="年度考核">
        ...
        <a-tabs type="card" @change="callback">
          ...
          <a-tab-pane key="2" tab="已审核" :forceRender="true">
            <dcaBAuditfive-done ref="TableInfo2" :state="3">
            </dcaBAuditfive-done>
          </a-tab-pane>
          <a-tab-pane key="3" tab="审核未通过" :forceRender="true">
            <dcaBAuditfive-done ref="TableInfo3" :state="2">
            </dcaBAuditfive-done>
          </a-tab-pane>
        </a-tabs>
...
export default {
  ...
  components: { DcaBAuditfiveDone, AuditUserInfo, DcaBDocAuditfiveEdit },
  mounted() {
    this.search();
  },
  props: {
  ...
  methods: {
    ...
    handleAuditNext(record) {
      ...
      this.$confirm({
        ...
        onOk() {
          ...
          that.loading = true;
          that
            .$post("dcaBDocAuditfive/updateNew", {
              jsonStr: jsonStr,
              state: 1,
            })
            .then(() => {
    ...
    fetch(params = {}) {
      ...
      this.loading = true;
      this.$get("dcaBDocAuditfive/audit", {
        ...params,
        state: 1,
      }).then((r) => {
        let data = r.data;
