      ...
      <a-card title="出站考核">
        ...
        <a-tabs type="card" @change="callback">
          ...
          <a-tab-pane key="2" tab="已审核" :forceRender="true">
            <dcaBDocAuditfivemiddle-done ref="TableInfo2" :state="3">
            </dcaBDocAuditfivemiddle-done>
          </a-tab-pane>
          <a-tab-pane key="3" tab="审核未通过" :forceRender="true">
            <dcaBDocAuditfivemiddle-done ref="TableInfo3" :state="2">
            </dcaBDocAuditfivemiddle-done>
          </a-tab-pane>
        </a-tabs>
        <audit-userInfo
...
import DcaBDocAuditfivemiddleDone from "./DcaBDocAuditfivemiddleDone";
...
export default {
  ...
  components: { DcaBDocAuditfivemiddleDone, AuditUserInfo ,DcaBDocAuditfivemiddleEdit},
  mounted() {
    this.search();
  },
  props: {
  ...
  methods: {
    ...
    handleAuditNext(record) {
      ...
      this.$confirm({
        ...
        onOk() {
          ...
          that.loading = true;
          that
            .$post("dcaBDocAuditfivemiddle/updateNew", {
              jsonStr: jsonStr,
              state: 1,
            })
            .then(() => {
    ...
    fetch(params = {}) {
      ...
      this.loading = true;
      this.$get("dcaBDocAuditfivemiddle/audit", {
        ...params,
        state: 1,
      }).then((r) => {
        let data = r.data;
