          ...
          >
            ...
            >
              ...
              >
                ...
                <div v-else>
                  <a-input-number
                    @blur="e => inputChange(e.target.value,record,'doctorNumber')"
                    :value="record.doctorNumber"
                    :precision="0"
                  >
                  </a-input-number>
                </div>
              ...
              >
                ...
                <div v-else>
                  <a-input-number
                    @blur="e => inputChange(e.target.value,record,'graduateNumber')"
                    :value="record.graduateNumber"
                    :precision="0"
                  >
                  </a-input-number>
                </div>
              ...
              >
                ...
                <div v-else>
                  <a-input-number
                    @blur="e => inputChange(e.target.value,record,'doctorDoneNumber')"
                    :value="record.doctorDoneNumber"
                    :precision="0"
                  >
                  </a-input-number>
                </div>
              ...
              >
                ...
                <div v-else>
                  <a-input-number
                    @blur="e => inputChange(e.target.value,record,'graduateDoneNumber')"
                    :value="record.graduateDoneNumber"
                    :precision="0"
                  >
                  </a-input-number>
                </div>
              ...
              >
                ...
                <div v-else>
                  <a-textarea
                    @blur="e => inputChange(e.target.value,record,'prizeContent')"
...
import DcaBGraduateDone from './DcaBGraduateDone'
...
export default {
  ...
  components: { DcaBGraduateDone, AuditUserInfo },
  mounted () {
    this.search()
  },
  props: {
  ...
  methods: {
    ...
    handleAudit (record) {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.loading = true
          that.$post('dcaBDocGraduate/updateNew', {
            jsonStr: jsonStr,
            state: 3
          }).then(() => {
            //this.reset()
    ...
    fetch (params = {}) {
      ...
      this.loading = true
      this.$get('dcaBDocGraduate/audit', {
        ...params,
        state: 1
      }).then((r) => {
        let data = r.data
    ...
    columns () {
      return [
        ...
        },
        {
          ...
          width: 130,
          scopedSlots: { customRender: 'doctorNumber' }
        },
        {
          title: '硕士在读人数',
