<template>
    <a-drawer
        ...
        <a-form :form="form">
                ...
                <a-form-item v-bind="formItemLayout"
                    label="填写日期">
                        <a-date-picker v-decorator="[ 'txDate', {rules: [{ required: true, message: '填写日期不能为空' }] }]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="成果概述">
                ...
                <a-form-item v-bind="formItemLayout"
                    label="主持研究的项目名称及研究计划">
                        <a-input placeholder="请输入主持研究的项目名称及研究计划" v-decorator="['zcyjxmyj', {rules: [{ required: true, message: '主持研究的项目名称及研究计划不能为空' }] }]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="博士后本人中期工作小结">
                        <a-input placeholder="请输入博士后本人中期工作小结" v-decorator="['bshbrzqxj', {rules: [{ required: true, message: '博士后本人中期工作小结不能为空' }] }]" />
                </a-form-item>
                <a-form-item v-bind="formItemLayout"
                    label="备注">
        ...
        methods: {
            ...
            handleSubmit () {
                this.form.validateFields((err, values) => {
                    if (!err) {
                    this.setFields()
                    this.$post('dcaBDocAuditfiveother', {
                        ...this.dcaBDocAuditfiveother
                    }).then(() => {
                        this.reset()
                        this.$emit('success')
            ...
            setFields () {
                let values = this.form.getFieldsValue([                    'khjg'    ,                     'khtype'    ,                     'khdate'    ,                     'userAccountName'    ,                     'userAccount'    ,                     'txDate'    ,                     'cggs'    ,                     'zcyjxmyj'    ,                     'bshbrzqxj'    ,                     'adContent'                   ])
                if (typeof values !== 'undefined') {
                    Object.keys(values).forEach(_key => { this.dcaBDocAuditfiveother[_key] = values[_key] })
                }
            }
        }
    }
