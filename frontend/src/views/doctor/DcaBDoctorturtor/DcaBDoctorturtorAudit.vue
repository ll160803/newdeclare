          ...
          >
            ...
            >
              ...
              >
                ...
                <div v-else>
                 <a-select
            :value="record.turtorType"
            style="width: 100px"
            @change="(e,f) => handleSelectChange(e,f,record,'turtorType')"
          >
            <a-select-option value="博士导师">
              博士导师
            </a-select-option>
            <a-select-option value="硕士导师">
              硕士导师
            </a-select-option>
          </a-select>
                </div>
              ...
              >
                ...
                <div v-else>
                  <a-date-picker
                    ...
                    @change="(e,f) => handleChange(e,f,record,'turtorDate')"
                  />
                </div>
              </template>
              <template
...
import DcaBDoctorturtorDone from './DcaBDoctorturtorDone'
...
export default {
  ...
  components: { DcaBDoctorturtorDone, AuditUserInfo },
  mounted () {
    this.search()
  },
  props: {
  ...
  methods: {
    ...
    exportCustomExcel () {
      ...
      this.$export('dcaBDocDoctorturtor/excel', {
    ...
    handleAuditNext (record) {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.loading = true
          that.$post('dcaBDocDoctorturtor/updateNew', {
            jsonStr: jsonStr,
            state: 1
          }).then(() => {
            //this.reset()
    ...
    fetch (params = {}) {
      ...
      this.loading = true
      this.$get('dcaBDocDoctorturtor/audit', {
        ...params,
        state: 1
      }).then((r) => {
        let data = r.data
    ...
    columns () {
      return [
        ...
        },
        {
          ...
          width: 130,
          scopedSlots: { customRender: 'turtorType' }
        },
        {
          title: '任职时间',
          dataIndex: 'turtorDate',
          width: 130,
          scopedSlots: { customRender: 'turtorDate' }
        },
        {
          title: '备注',
