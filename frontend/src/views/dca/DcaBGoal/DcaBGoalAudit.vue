      ...
      <a-card title="拟聘岗位工作思路及预期目标">
        ...
        >
          <a-textarea
            ...
            :rows="16"
            placeholder="拟聘岗位工作思路及预期目标"
          ></a-textarea>
          <a-textarea
            :value="dcaBGoal.auditSuggestion"
