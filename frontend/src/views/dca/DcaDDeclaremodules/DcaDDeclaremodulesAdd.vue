...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setFields () {
                let values = this.form.getFieldsValue([                    'code'    ,                     'name'    ,                     'parentId'    ,                     'orderNum'                   ])
                if (typeof values !== 'undefined') {
                    Object.keys(values).forEach(_key => { this.dcaDDeclaremodules[_key] = values[_key] })
                }
            }
        }
    }
