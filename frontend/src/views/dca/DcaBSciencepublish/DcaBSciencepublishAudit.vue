      ...
      <a-card title="任现职以来发表的论文">
        ...
        <a-tabs type="card" @change="callback">
          ...
          <a-tab-pane key="2" tab="已审核" :forceRender="true">
            <dcaBSciencepublish-done ref="TableInfo2" :state="3">
...
import DcaBSciencepublishEdit from "./DcaBSciencepublishEditAudit";
    ...
    inputCheckChange(blFlag, f, record, filedName) {
      ...
      if (filedName == "isJxzcsb") {
        if (blFlag) {
          ...
          if (
            record["auditTotalnum"] != "" &&
            record["auditTotalnum"] != null
          ) {
