        ...
        >
          ...
          >
            ...
            >
              ...
              <div v-else>
                <a-textarea
                  @blur="e => inputChange(e.target.value,record,'ifgoucheng')"
  ...
  methods: {
    ...
    exportCustomExcel () {
      ...
      let listj = ['edu', 'eduDate', 'ylpfbfz', 'ylpfdj', 'jxpf', 'jxpfdj', 'sciName', 'sciDengji', 'sciRanknum', 'teachName',
        ...
        'publishDup', 'publishEup', 'publishFup', 'publicarticle1', 'publicarticle2', 'patentNum', 'patentFund',
        'courseDengji', 'courseRanknum',
        'courseDate', 'sciDjlb', 'sciDjfund', 'sciDjranknum',
        'sciJflb', 'sciJffund', 'sciJfranknum', 'pfHeji', 'tutor', 'teacherQualify', 'borad', 'auditMan',
        'ydyf', 'ydyffj', 'zzsc', 'zzscypfj', 'jlsc', 'jlscypfj', 'xsddsc', 'xsddscypfj', 'zypfyjxl', 'zypfdjyjxl', 'yyxtsc', 'yyxtypfj', 'zypfbfz58', 'zypfdj59', 'sfssds', 'sfbsds', 'sftgsdsf',
        'sdsfypfj', 'jxpf', 'jxpfdj', 'sdsfypfj2', 'ynjbzr', 'j5njxgz', 'mzylpf', 'mzylpfdj', 'mzylsgypfj', 'ylpfbfz', 'ylpfdj', 'sfypfjyl', 'sfyszgzs',
        'hlylpf', 'hlylpfdj', 'hljxpfbfz', 'hljxpfdl', 'hlhlzrypfj', 'sfjyhlzgzs', 'sshbdts', 'sshkyxts', 'blxwjf', 'wfzgszcf', 'xingfscsftg', 'sfczxfypfj61',
        'zypf52', 'zypfdj52', 'beizhuyiwuchu', 'beizhumenban', 'beizhuhuli', 'yearmore'];
