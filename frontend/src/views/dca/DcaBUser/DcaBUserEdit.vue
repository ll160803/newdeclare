    ...
    <a-drawer
        ...
        <a-form :form="form">
                ...
                <a-form-item
                        v-bind="formItemLayout"
                        label="聘任时间">
                        <a-date-picker v-decorator="[ 'appointedDate', {rules: [{ required: true, message: '聘任时间不能为空' }] }]" />
                </a-form-item>
                <a-form-item
                        v-bind="formItemLayout"
                        label="本人排名">
    ...
    export default {
        ...
        methods: {
            ...
            setFormValues ({...dcaBUser}) {
                let fields = [  'userAccountName'    , 'userAccount'    , 'deptName'    , 'positionName'    , 'npPositionName'    , 'sexName'    , 'birthday'    , 'schoolDate'    , 'zyjsgw'    , 'xcszyjzc'    , 'appointedDate'    , 'patentRanknum'    , 'isAuthority'     , 'isZhuanrang'     , 'patentGood'          , 'auditMan'    , 'auditManName'    , 'auditDate'    , 'auditSuggestion'    , 'IsUse'    ]
                let fieldDates = [         'birthday'       , 'schoolDate'         , 'appointedDate'                     , 'auditDate'      ]
