...
export default {
  ...
  methods: {
    ...
    setFields () {
      let values = this.form.getFieldsValue(['userAccount', 'lastContent', 'state'])
      if (typeof values !== 'undefined') {
        Object.keys(values).forEach(_key => { this.dcaBLastemploy[_key] = values[_key] })
      }
    }
  }
}
