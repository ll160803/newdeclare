...
import KhDetail from './KhDetail.vue'
import UserInfo from './KhUserInfo'
  ...
  methods: {
    ...
    exportCustomExcel () {
     ...
     //  json.splice(this.columns.length-1,1) //移出最后一个
      ...
      this.$export('khDScore/excelDetail', {
        dataJson: dataJson,
        ...queryParams
      })
    },
